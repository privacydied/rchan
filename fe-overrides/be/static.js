...
exports.setThreadTitle = function(document, threadData) {
  ...
  // --- rchan: per-thread Open Graph / Twitter tags for link previews ---
  try {
    ...
    var ogTitle = threadData.subject || ('Thread #' + threadData.threadId);
    ...
    var og = '<meta property="og:type" content="article">'
        + '<meta property="og:site_name" content="rchan">'
        + '<meta property="og:url" content="' + escU(ogUrl) + '">'
        + '<meta property="og:title" content="' + escT(ogTitle) + '">'
        + '<meta property="og:description" content="' + escT(ogDesc) + '">'
        + '<meta property="og:image" content="' + escU(ogImg) + '">'
    ...
    // never let preview tags break thread rendering
  }
...
exports.page = function(page, threads, pageCount, boardData, flagData,
  ...
  // --- rchan: per-board Open Graph tags ---
  try {
    var bEsc = function(s) {
      return String(s == null ? '' : s).replace(/&/g, '&amp;')
          .replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;')
